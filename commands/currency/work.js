...
module.exports.run = async (cobalt, message, args, addCD, cb) => {
    try {
        ...
        let workEntries = [
            ...
            `${message.author.username} drone strike'd children in Yemen for:`,
            `${message.author.username} works at Tencent for:`,
            `${message.author.username} had an epic poggers moment and got:`,
            `${message.author.username} sold some cheese and got:`,
            `${message.author.username} took out the alien form among us for: `,
        ];
