...
module.exports.run = async (cobalt, message, args, addCD, cb) => {
    try {
        ...
        const description = (data) => {
            return `Total Servers - ${cobalt.guilds.cache.size}\n\n` +
                cobalt.guilds.cache
        ...
        const genEmbed = (message, data) => {
            ...
            let embed = new Discord.MessageEmbed()
                ...
                .setFooter(cobalt.user.username)
        ...
        const reactEmbed = async (botMessage, clientMessage, data) => {
            ...
            let collector = botMessage.createReactionCollector((reaction, user) => user.id === clientMessage.author.id);
            ...
            collector.on("collect", async (reaction, user) => {
                if (reaction.emoji.name === "⬅") {
                    ...
                    // Edit the message
                    botMessage.edit(genEmbed(clientMessage, data));
                }
                ...
                if (reaction._emoji.name === "➡") {
                    ...
                    // Edit the message
                    botMessage.edit(genEmbed(botMessage, data));
                }
        ...
        reactEmbed(await message.channel.send(embed), message, data);
    } catch (e) {
        cb(e)
    }
}
